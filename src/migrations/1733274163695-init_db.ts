...
export class InitDb1733274163695 implements MigrationInterface {
    name = 'InitDb1733274163695'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "plan_schedule_item" ("id" SERIAL NOT NULL, "startTime" TIMESTAMP, "endTime" TIMESTAMP, "reservationCode" character varying, "note" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "scheduleId" integer, "serviceId" integer, CONSTRAINT "PK_0145ff717149fc88be9d4dff449" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "plan_schedule" ("id" SERIAL NOT NULL, "day" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "locationId" integer, "planId" integer, CONSTRAINT "PK_b94a564c9bdb6511358e1079afe" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "plan_schedule_item" ADD CONSTRAINT "FK_cb7805e6b8d6ed75fc6312b1e4a" FOREIGN KEY ("scheduleId") REFERENCES "plan_schedule"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "plan_schedule" ADD CONSTRAINT "FK_fe7980ce429d461ba0e3db45786" FOREIGN KEY ("planId") REFERENCES "plan"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
